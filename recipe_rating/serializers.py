...
class RecipeRatingSerializer(serializers.ModelSerializer):
    ...
    your_rating = serializers.ChoiceField(choices=RecipeRating.
                                          rating.field.choices,
                                          source='rating')
    ...
    def get_is_user(self, obj):
        """
        Check if the request's user is the object's user,
        ensuring object is saved and request is authenticated.
        """
